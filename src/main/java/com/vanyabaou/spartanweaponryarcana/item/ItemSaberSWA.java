...
public class ItemSaberSWA extends ItemSaber implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemSaberSWA(String unlocName, ToolMaterialEx material) {
