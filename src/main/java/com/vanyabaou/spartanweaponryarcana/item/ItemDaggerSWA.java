...
public class ItemDaggerSWA extends ItemDagger implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemDaggerSWA(String unlocName, ToolMaterialEx material) {
