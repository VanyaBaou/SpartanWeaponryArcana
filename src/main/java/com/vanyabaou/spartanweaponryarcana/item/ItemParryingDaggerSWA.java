...
public class ItemParryingDaggerSWA extends ItemParryingDagger implements IManaUsingItem, IPixieSpawner, ILensEffect
{
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemParryingDaggerSWA(String unlocName, ToolMaterialEx material)
	{
