...
public class ItemKatanaSWA extends ItemKatana implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemKatanaSWA(String unlocName, ToolMaterialEx material) {
