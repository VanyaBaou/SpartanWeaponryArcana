...
public class ItemWarhammerSWA extends ItemWarhammer implements IManaUsingItem, IPixieSpawner, ILensEffect
{
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemWarhammerSWA(String unlocName, ToolMaterialEx material) 
	{
