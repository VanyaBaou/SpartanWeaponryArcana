...
public class ItemPikeSWA extends ItemPike implements IManaUsingItem, IPixieSpawner, ILensEffect
{
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemPikeSWA(String unlocName, ToolMaterialEx material) 
	{
