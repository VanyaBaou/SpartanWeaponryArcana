...
public class ItemLongswordSWA extends ItemLongsword implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemLongswordSWA(String unlocName, ToolMaterialEx material) {
