...
public class ItemThrowingAxeSWA extends ItemThrowingAxe implements IManaUsingItem, IPixieSpawner {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemThrowingAxeSWA(String unlocName, ToolMaterialEx material) {
