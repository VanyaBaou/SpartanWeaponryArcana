...
public class ItemQuarterstaffSWA extends ItemQuarterstaff implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemQuarterstaffSWA(String unlocName, ToolMaterialEx material) {
