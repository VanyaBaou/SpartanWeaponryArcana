...
public class ItemLanceSWA extends ItemLance implements IManaUsingItem, IPixieSpawner, ILensEffect {
	protected boolean usesMana = false;
	float pixieChance = 0.0f;

	public ItemLanceSWA(String unlocName, ToolMaterialEx material) {
